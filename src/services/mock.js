// Mock data for Taiwan stock market — used when APIs are unavailable
...
export const MOCK_STOCKS = [
  ...
  { code: '2454', name: '聯發科', price: 1250.00, change: 35.00, changePct: 2.88, volume: 9876500, pe: 22.1, pb: 5.3, marketCap: 1984 },
  ...
  { code: '3008', name: '大立光', price: 2540.00, change: -20.00, changePct: -0.78, volume: 1234500, pe: 42.3, pb: 9.1, marketCap: 851 },
...
export const MOCK_STRONG_STOCKS = [
  ...
  { code: '4938', name: '和碩', price: 98.5, changePct: 4.21, rs: 89, volume: 15432100, volumeRatio: 4.5, signal: '放量' },
  ...
  { code: '3711', name: '日月光投控', price: 175, changePct: 1.98, rs: 84, volume: 12345600, volumeRatio: 1.5, signal: '強勢' },
  { code: '2382', name: '廣達', price: 345, changePct: 3.13, rs: 83, volume: 8765400, volumeRatio: 2.1, signal: '放量' },
  { code: '2357', name: '華碩', price: 580, changePct: 2.47, rs: 81, volume: 4567800, volumeRatio: 1.9, signal: '強勢' },
]
...
export const MOCK_TRADING_STATS = {
  date: '2024-06-09',
  totalVolume: 289543210000,
  totalTurnover: 456789012345,
  advances: 687,
  declines: 312,
  unchanged: 98,
  limitUp: 23,
  limitDown: 5,
  foreignNetBuy: 38900000000,
  trustNetBuy: 5670000000,
  dealerNetBuy: -2340000000,
  marginBalance: 1234567890000,
  shortBalance: 345678900000,
  buyByType: [
  ...
  sectorPerformance: [
    { sector: '半導體', changePct: 2.34 },
    { sector: '電子', changePct: 1.87 },
    { sector: '金融', changePct: 0.92 },
    { sector: '傳產', changePct: -0.45 },
    { sector: '鋼鐵', changePct: -1.23 },
    { sector: '航運', changePct: 3.45 },
    { sector: '生技', changePct: 0.67 },
    { sector: '建材', changePct: -0.89 },
  ]
}
...
export const MOCK_NEWS = [
  ...
  { id: 7, title: '台灣通膨維持穩定，央行利率政策按兵不動', source: '中央社', time: '5小時前', category: '總經', sentiment: 'neutral', stock: null },
  { id: 8, title: '航運股受惠運費回升，陽明、長榮雙雙大漲', source: '財訊', time: '6小時前', category: '航運', sentiment: 'positive', stock: null },
]
